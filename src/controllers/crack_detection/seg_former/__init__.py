...
class FormerCrackSeg():
    ...
    def infer(self,img_folder, save_results=True):
        ...
        for img_path in paths:
            ...
            if self.out_pred_dir is not None:
                crack_mask_pil.save(os.path.join(self.out_pred_dir, f'{img_path.stem}_mask.jpg'))
                seg_results.append(os.path.join(self.out_pred_dir, f'{img_path.stem}_mask.jpg'))
            ...
            if self.out_viz_dir is not None:
                ...
                # plt.show()
                plt.savefig(os.path.join(self.out_viz_dir, f'{img_path.stem}_viz.jpg'), dpi=500)
                plt.close('all')

                seg_results.append(os.path.join(self.out_viz_dir, f'{img_path.stem}_viz.jpg'))
